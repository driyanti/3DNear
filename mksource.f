      SUBROUTINE mksource(p,omega,Su,Sd,v_src_min,v_src_plus,
     .			  force_direction,azimuthal)
...
!
      ...
      integer     force_direction,azimuthal
      real*8	  omega,p,forcefactor
...
ccccorde azimuthal (0) 
       
        IF ( azimuthal .eq. 1) THEN
...
ccccorde azimuthal (1) 

        
       IF (azimuthal .eq. 2) THEN
